...
#################################
accelerator = "unit_tests_accelerators/four_cores.yaml"
workload_path = "unit_tests_workloads/test_4_indep_workload.onnx"
mapping_path = "unit_tests_accelerators/four_cores_mapping.yaml"

# added this to customize the path to the output
example_name = "test_4_4cores_no_MemTile"
