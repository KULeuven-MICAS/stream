...
############################## Provide inputs ######################################
workload_path = "lab1/inputs/workload/workload.yaml"
accelerator = "lab1/inputs/hardware/hda_bus.yaml"
mapping_path = "lab1/inputs/mapping/mapping.yaml"
timeline_fig_path_plotly = f"lab1/outputs/timeline.html"
memory_fig_path = f"lab1/outputs/memory_usage.png"
####################################################################################
...
node_hw_performances_path = f"lab1/outputs/{node_hw_cost_pkl_name}.pickle"
visualize_node_hw_performances_path = (
    f"lab1/outputs/{node_hw_cost_pkl_name}_visualization.png"
)
nb_ga_generations = 0
nb_ga_individuals = 0
####################################################################################
