...
def run_main_aie_codegen_swiglu(  # noqa: PLR0913
    x, y, out_channels, m, k, n, in_dtype, out_dtype, trace_size, rows, cols, npu, line_size
):  # noqa: N803, PLR0913
    ############################################INPUTS############################################
    ...
    logger.info(f"Running AIE code generation for Swiglu with x={x}, y={y}, out_channels={out_channels}")
    ######################################################################
...
if __name__ == "__main__":
    ...
    parser.add_argument("--x", type=int, required=True, help="Number of input samples (x dim of the input)")
    parser.add_argument("--y", type=int, required=True, help="Number of input channels (y dim of the input)")
    parser.add_argument("--out_channels", type=int, required=True, help="Number of output channels (y dim of output)")
