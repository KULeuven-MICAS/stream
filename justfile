...
swiglu3:
    python main_swiglu.py --seq_len 512 --embedding_dim 512 --hidden_dim 512 --in_dtype bf16 --out_dtype bf16 --trace_size 1048576 --rows 4 --cols 4 --npu npu2 --no_last_gemm_down
