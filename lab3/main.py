...
############################## Provide inputs ######################################
workload_path = "lab3/inputs/workload/workload.yaml"
accelerator = "lab3/inputs/hardware/hda_bus.yaml"
mapping_path = "lab3/inputs/mapping/mapping.yaml"
timeline_fig_path_plotly = f"lab3/outputs/timeline.html"
memory_fig_path = f"lab3/outputs/memory_usage.png"
####################################################################################
...
node_hw_performances_path = f"lab3/outputs/{node_hw_cost_pkl_name}.pickle"
visualize_node_hw_performances_path = (
    f"lab3/outputs/{node_hw_cost_pkl_name}_visualization.png"
)
