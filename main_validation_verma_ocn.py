...
#################################
CN_define_mode = 1
hint_loops = [("OX", 28), ("OY", 56)]
# hint_loops = [("OY", 56)]


accelerator = "stream.inputs.validation.verma_ocn.hardware.verma"
workload_path = "stream.inputs.validation.verma_ocn.workload.resnet50_segment3"
mapping_path = "stream.inputs.validation.verma_ocn.mapping.mapping"
