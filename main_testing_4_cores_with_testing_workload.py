...
#################################
accelerator = "stream/inputs/testing/hardware/quad_testing_core_offchip.yaml"
workload_path = "stream/inputs/testing/workload/testing_workload_for_4_cores.yaml"
