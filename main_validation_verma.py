...
accelerator = "stream.inputs.validation.verma.hardware.verma"
workload_path = "stream.inputs.validation.verma.workload.resnet50_segment3"
mapping_path = "stream.inputs.validation.verma.mapping.mapping"
