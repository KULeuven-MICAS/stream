...
- [x] **Phase 27: ResNet18 Fusion Strategy** - Implement Add+Relu residual boundary heuristic and extend split_fusion_groups() with explicit cut points so ResNet18 splits into 11 manageable groups (completed 2026-05-14)
...
- [x] 27-02-PLAN.md — Integration test (MappingValidator for 11 groups) + skills documentation update
