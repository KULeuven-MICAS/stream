...
- [x] **TOOL-02**: `get_workload_ir` and `get_accelerator_ir` tools return parsed workload DAG and hardware topology as structured JSON matching Pydantic IR schemas
