from stream.inputs.exploration.hardware.cores.C32_K32 import get_core
...
cores = [get_core(id) for id in range(1)]  # 4 identical cores
...
accelerator = Accelerator(
    "HW1_1bigcore_dpDRAM", cores_graph, offchip_core_id=offchip_core_id
)
