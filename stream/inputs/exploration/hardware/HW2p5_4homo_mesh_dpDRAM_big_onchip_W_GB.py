from stream.inputs.exploration.hardware.cores.C16_K16_big_onchip_W_GB import get_core
...
accelerator = Accelerator(
    "HW2p5_4homo_mesh_dpDRAM_big_onchip_W_GB", cores_graph, offchip_core_id=offchip_core_id
)
