from stream.inputs.exploration.hardware.cores.C32_K32_big_onchip_W_GB import get_core
...
accelerator = Accelerator(
    "single_core_32x32_mesh_dpDRAM", cores_graph, offchip_core_id=offchip_core_id
)
