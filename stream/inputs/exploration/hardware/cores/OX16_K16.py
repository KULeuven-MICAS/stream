...
def get_memory_hierarchy(multiplier_array):
    ...
    memory_hierarchy_graph.add_memory(
        memory_instance=reg_64B_2r2w_16b(),
        operands=("O",),
        port_alloc=(
    ...
    memory_hierarchy_graph.add_memory(
        memory_instance=reg_512B_1r1w_8b(),
        operands=("I2",),
    ...
    memory_hierarchy_graph.add_memory(
        memory_instance=sram_32KB_2_16KB_1r1w_64b(),
        operands=("I1",),
        port_alloc=(
    ...
    memory_hierarchy_graph.add_memory(
        memory_instance=sram_256KB_2_128KB_1r1w_64b(),
        operands=("I2",),
        port_alloc=({"fh": "w_port_1", "tl": "r_port_1", "fl": None, "th": None},),
        served_dimensions="all",
    )
...
def get_operational_array():
    ...
    multiplier_area = 1
    dimensions = {"D1": 16, "D2": 16}  # {'D1': ('K', 16), 'D2': ('OX', 16)}
...
def get_dataflows():
    return [{"D1": ("K", 16), "D2": ("OX", 16)}, {"D1": ("G", 16)}]
