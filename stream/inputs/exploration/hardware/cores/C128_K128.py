...
def get_memory_hierarchy(multiplier_array):
    ...
    memory_hierarchy_graph.add_memory(
        memory_instance=sram_2MB_128_16KB_1r1w_16b(),
        operands=("I1", "O"),
        port_alloc=(
    ...
    memory_hierarchy_graph.add_memory(
        memory_instance=sram_16MB_128_128KB_1r1w_8b(),
        operands=("I2",),
        port_alloc=({"fh": "w_port_1", "tl": "r_port_1", "fl": None, "th": None},),
        served_dimensions="all",
    )
    ...
    memory_hierarchy_graph.add_memory(
        memory_instance=sram_16MB_128_128KB_1r1w_16b(),
        operands=("I1", "O"),
        port_alloc=(
            {"fh": "w_port_1", "tl": "r_port_1", "fl": None, "th": None},
            {"fh": "w_port_1", "tl": "r_port_1", "fl": "w_port_1", "th": "r_port_1"},
...
def get_dataflows():
    return [{"D1": ("K", 128), "D2": ("C", 128)}, {"D1": ("G", 128)}]
