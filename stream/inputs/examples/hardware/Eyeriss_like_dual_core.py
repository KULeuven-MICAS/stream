from stream.inputs.examples.hardware.cores.Eyeriss_like import (
...
cores = [get_eyeriss_like_core(id) for id in range(2)]  # 2 identical cores
...
accelerator = Accelerator("Eyeriss-like-dual-core", cores_graph, offchip_core_id=offchip_core_id)
