from stream.inputs.testing.hardware.cores.testing_core1 import (
    get_core as get_testing_core1,
)
from stream.inputs.testing.hardware.cores.testing_core2 import (
...
accelerator = Accelerator(
    "Testing-4-core-with-offchip", cores_graph, offchip_core_id=offchip_core_id
)
