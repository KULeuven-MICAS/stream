from stream.inputs.examples.hardware.cores.Meta_prototype_like import (
    get_core as get_meta_prototype_core,
)
...
accelerator = Accelerator(
    "Meta-proto-2-core-with-pooling-and-offchip-cores",
    cores_graph,
    global_buffer,
