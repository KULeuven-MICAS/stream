...
from stream.inputs.validation.verma_ocn.hardware.noc.noc import (
    fixed_interconnect_with_offchip,
)
...
accelerator = Accelerator("verma-ocn", cores_graph, offchip_core_id=offchip_core_id)
