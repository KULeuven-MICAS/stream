...
# )
from stream.inputs.aie.hardware.shim_dma_core import get_shim_dma_core as shim_core
...
cores_graph = get_2d_mesh(
    ...
    nb_cols=4,
    bandwidth=64 * 8,
    # pooling_core=mem_tile_core,
    unit_energy_cost=0,
    # mem_tile_core=mem_tile_core,
    offchip_core=offchip_core,
)  # , offchip_bandwidth=32)

accelerator = Accelerator("AIE2_IPU", cores_graph, offchip_core_id=offchip_core_id)
