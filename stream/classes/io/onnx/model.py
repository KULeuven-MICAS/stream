    ...
    def parse_workload_from_onnx_model_and_mapping(self):
        ...
        for node_id, node in enumerate(self.onnx_model.graph.node):
            ...
            if node.op_type in ["QLinearConv", "Conv"]:
                ...
                logger.info(f"Parsed Reshape node {node.name}.")
                ...
                # TODO: a temporary fix for inception-v2 like Add or Mul which has asymmetric input data -> treat it as a DummyNode.
